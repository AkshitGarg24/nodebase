...
export type HttpDialogFormType = z.infer<typeof formSchema>;

interface HttpRequestDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onSubmit: (values: HttpDialogFormType) => void;
    defaultEndpoint: string;
    defaultMethod?: "GET" | "POST" | "PUT" | "PATCH" | "DELETE";
    defaultBody?: string;
}

export const HttpRequestDialog = ({ open, onOpenChange, onSubmit, defaultBody, defaultEndpoint, defaultMethod = "GET" }: HttpRequestDialogProps) => {
    ...
    const handleSubmit = (values: HttpDialogFormType) => {
        onSubmit(values);
        onOpenChange(false);
    }
